...
function History() {
  ...
  return (
    <div className='w-full h-full flex flex-col absolute px-4 pt-4 bg-black rounded-2xl max-w-sm z-10   ssm:border-r ssm:border-r-border ssm:border-l ssm:border-l-border'>

      <section className="w-full h-auto pb-4 flex flex-row justify-between border-b border-b-border">
