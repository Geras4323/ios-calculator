  ...
  return (
    <ResultsContext.Provider value={results}>
        ...
        <div className="w-screen h-screen flex justify-center">
          ...
          <div className='w-96 h-full flex flex-col justify-end p-4 bg-black rounded-2xl max-w-sm   ssm:border-r ssm:border-r-border ssm:border-l ssm:border-l-border'>
